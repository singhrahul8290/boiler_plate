...
class MakeRepository extends CommandGenerator
{    
    /**
     * argumentName
     *
    ...
    {
        return app_path()."/Repository/Eloquent".'/'. $this->getRepositoryName() . '.php';
    }
    ...
    {
        return app_path()."/Repository".'/'. $this->getInterfaceName() . '.php';
    }
